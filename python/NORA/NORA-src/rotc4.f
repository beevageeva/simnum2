...
C*****************************************************************************
             ...
             SUBROUTINE rotc4 (gdev, nbods, istart, iend,  theta, phi,
     &				 PA, coordmax, swidth,
     &                           filename, model1, model2, modinc, 
     &				 add,ivdist, GRAVC, Vmax,sigma,infostr)
...
C*****************************************************************************
	...
	INTEGER nbods
        ...
        PARAMETER (nbin=50, nhalf = nbin/2,  maxinbin = 40000)
                                                        ! want nbin even.
        REAL theta, phi, GRAVC, Vmax, sigma
	...
	REAL errtop(nbin), errbot(nbin),vrm(nbin)
	CHARACTER*(*) gdev
