...
C**************************************************************************
	      ...
	      SUBROUTINE ptplot3(gdev, istart, iend, theta, phi, 
     &				coordmax,scalel,infostr) 
...
C-------
	DO 20 i = 1, iend-istart+1
	    xbuff(i) = xbuff(istart+i-1)/scalel
	    ybuff(i) = ybuff(istart+i-1)/scalel
