...
C************************************************************************
                ...
                SUBROUTINE ebindcol (gdev, coordmin, coordmax,elow,eupp,
     &istart, iuno, imid, iend, infostr)
...
C-----------------------------------------------------------------------------
	...
	REAL dist(nbin), dist2(nbin),coordmin, eupp, elow
        ...
        INTEGER n, i, k, istart, iuno, imid, iend, nbods,m
...
C--------
	...
	CALL ebinoutc(gdev,dist, ebin, dist2, t2wbin, coordmin,coordmax,
     &	istart,iuno,imid,iend,r, eb,t2w, ec,r0,infostr)
