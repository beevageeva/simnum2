...
C                   ANGULAR MOMENTUM VECTOR.
      ...
      PHI=(ACOS(LI3/L))*(180/3.141592654)
       IF (PHI.LT.0) THEN PHI=-PHI

       IF (PHI.GT.180) THEN PHI=PHI-180


       
      THETA=(ACOS(LI1/(L*SIN(PHI))))*(180/3.141592654)
      THETA1=(ASIN(LI2/(L*SIN(PHI))))*(180/3.141592654)
       IF (THETA1.LT.0) THEN THETA =360-THETA
...
C
   ...
   50 CONTINUE
      WRITE(6,2013)
      WRITE(6,2014) LI1,LI2,LI3,L,PHI,THETA
