...
C*****************************************************************************
      ...
      SUBROUTINE ebinout(gdev,dist,ebin,dist2,t2wbin,coordmin,coordmax,
     &  	istart,iend,r, eb,t2w,mass,r0,infostr)
	...
	CALL PGLABEL ('R', 'Ebind', ' ')
        	   CALL PGSCH (2.0)
                   ...
                   DO 6 i=1,nbods
                      ...
                      ebb(i)=eb(istart+i)
 6                 continue   
	CALL PGPOINT (nbods, rr, ebb, dot)
c                   CALL PGPOINT (1,0.5,-2,dot)
  
        print*,'HOLA',nbods,istart,iend,ebb(1),rr(1)
